...
export default function ModalOrcamento({ isOpen, onClose, onSave }) {
  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 z-50 flex justify-center pt-[15px] px-4 pointer-events-none">
        <div className="pointer-events-auto bg-[#ffffff] gap-[20px] w-[400px] max-w-[95%] rounded-[16px] p-[20px] shadow-2xl flex flex-col overflow-hidden h-[320px] border border-[#C4C4C9]">
