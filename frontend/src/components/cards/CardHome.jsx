...
export default function CardHome({ img, titulo, path }) {
  ...
  return (
    <div
      ...
      className="w-full h-[210px] rounded-[10px] cursor-pointer flex flex-col justify-center items-center bg-white/30 backdrop-blur-md border border-white/40 shadow-sm transition-all duration-300 hover:bg-white/40 hover:shadow-lg
   hover:scale-105
        hover:shadow-lg"
    >
