...
export const orcSecaoTituloClass = "text-sm font-semibold text-esc-text";

export const orcSecaoDescricaoClass =
  "mt-0.5 text-xs text-esc-muted leading-relaxed";
...
export const orcGridValoresClass =
  "grid grid-cols-1 gap-4 sm:grid-cols-2";

export const orcLabelCampoClass =
  "mb-1.5 block text-xs font-semibold uppercase tracking-wide text-esc-muted";

export const orcTotalBarClass =
  "flex flex-wrap items-center justify-between gap-3 rounded-xl border border-esc-destaque/30 bg-esc-destaque/10 px-4 py-3";
