...
const DeclaracaoMovimentacaoSoloLayout = ({ cliente }) => (
  <Page size="A4" style={styles.page}>
    ...
    <Text style={styles.paragraph}>
      ...
      <Text>216305/D</Text> , responsável técnico pela obra localizada à{" "}
      <Text>
        {cliente?.rua_obra || ""} {cliente?.numero_obra || ""},{" "}
        {cliente?.bairro_obra || ""}
      </Text>
      , inscrita sob o processo nº {cliente?.numero_processo || ""}, em
      atendimento ao disposto no Art. 3º da Portaria nº 003/2015, publicada no
      Porta-Voz nº 1312/15 de 17/07/2015, que trata da necessidade de proteção e
      gerenciamento integrado das reservas fossilíferas,{" "}
    ...
    <Text style={styles.paragraph}>
      ...
      formações sedimentares locais, em especial às Formações Geológicas Uberaba
      e Marília (Membros Ponte Alta e Serra da Galga), ao Vale do Rio do Peixe e
      aos Depósitos Aluviais Cenozoicos, conforme alínea "a" do Art. 3º da
      referida Portaria.
    </Text>
    ...
    <Text style={styles.paragraph}>
      ...
      acompanhado da devida ART — Anotação de Responsabilidade Técnica, conforme
